...
class IndexTTS2:
    def __init__(
        ...
        lora.apply_lora_to_gpt(self.gpt,8, 16)#version4
        #lora.apply_lora_to_finalnorm(self.gpt,8, 0) #,16)#version4c
    ...
    def infer(self, spk_audio_prompt, text, output_path,
        ...
        #lora.apply_qk_only_mask(self.gpt) #version4g
        lora.apply_surgical_lora(self.gpt,0,7)
...
if __name__ == "__main__":
    ...
    #prompt_wav = "examples/voice_05.wav"
    prompt_wav = "seasalt-tts-data/tongtong/wavconverted/U02158.wav"
    #prompt_wav = "seasalt-tts-data/vivian/wavconverted/U02158.wav"
