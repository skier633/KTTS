...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        default=Path("chinese_dataset/train.jsonl"),
...
def process_sample(
    ...
    #text_tokens = tokenizer.tokenize(text, language="ja") ## Jia
    ...
    waveform, sr = load_audio(audio_path, target_sr=22050) # 24000) Jia
...
def main() -> None:
    ...
    #tokenizer = TextTokenizer(str(args.tokenizer), TextNormalizer(preferred_language="ja")) ## Jia
    tokenizer = TextTokenizer(str(args.tokenizer), TextNormalizer())
